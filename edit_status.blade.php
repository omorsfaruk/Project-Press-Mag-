    ...
    <section class="d-flex">
      <div class="row">
        ...
        <div class="col-md-6 m-5 d-flex">
          <form class="form-group" action="{{URL::to('/update-status/'.$status_info->status_id)}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="">
              ...
              <input class="form-control px-5 mx-5" placeholder="Enter Your Video Title" type="text" name="update_status_title" value="{{$status_info->status_title}}">
            </div>
            <div class="">
              <label class="font-weight-bold" for=""> Upload Video
                <input class="form-control px-5 mx-5" style=" margin-left: 3px; height: 40px; width: 300px; border-radius: 5px;   "   placeholder="Enter Your product_image" type="file" name="update_status" value="{{$status_info->status}}">
                </label>
            </div>
            ...
            <div class="">
              ...
              <input class="form-control px-5 mx-5" placeholder="Enter Your Short Discription" type="text" name="update_status_short_discription" value="{{$status_info->status_short_discription}}">
            </div>

            <div class="">
              <label class="font-weight-bold" for=""> Video Long Discription</label>
              <input class="form-control px-5 mx-5" type="text" placeholder="Enter Your Long Discription" name="update_status_long_discription" value="{{$status_info->status_short_discription}}">
            </div>
