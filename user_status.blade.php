...
@section('content')
    ...
    <section class="d-flex">
      <div class="row">
        ...
        <?php
        $user_value=Session::get('user_id');
         ?>
        <div class="col-md-6 m-5 d-flex">
          <form class="form-group" action="{{url('/save-user-status/'.$user_value)}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="">
              ...
              <input class="ml-5 " type="checkbox"  name="publication_status" value="0">
